...
{{- include "common.images.image" (dict "imageRoot" .Values.wordpressImage "global" .Values.global) -}}
{{- end -}}
...
{{- include "common.images.pullSecrets" (dict "images" (list .Values.wordpressImage .Values.nginxImage .Values.volumePermissions.image) "global" .Values.global) -}}
{{- end -}}
